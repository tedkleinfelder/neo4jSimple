...
neo4jSimple.prototype.getOutgoingRelationshipsForNode(id, cb) {
    // reference_node + '/relationships/out'
    ...
    var options = {
        uri: this.serviceRoot.node+'/'+srcId+'/relationships/out',
        Accept: 'application/json'
    };
...
neo4jSimple.prototype.getIncomingRelationshipsForNode(id, function(err, relationships) {
};
